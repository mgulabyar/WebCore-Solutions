...
function BlogHero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-20 pb-16 lg:pt-20 lg:pb-20">
      <style>{`
        .blog-hero-left {
          opacity: 0;
...
function BlogSidebar({
  ...
  return (
    <aside className="flex flex-col gap-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-[#0062D6] to-[#0B3C95] p-6 shadow-[0_10px_30px_rgba(0,98,214,0.2)]">
