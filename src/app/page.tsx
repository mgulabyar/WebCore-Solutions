  ...
  return (
    <section className="relative w-full min-h-[80vh] flex items-center overflow-hidden bg-[#fbfcfe] mt-0 pt-0 pb-16 text-slate-900 lg:min-h-[85vh]">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-4 px-5 mt-0 pt-0 lg:grid-cols-2 lg:gap-12 lg:px-8">
        ...
        <div className="relative flex h-[310px] w-full items-center justify-center overflow-visible sm:h-[480px] lg:h-[510px] max-sm:pt-14 mt-4 lg:mt-0">
          {/* Reduced gap: outer circle 250/300/340, inner circle 140/160/180 */}
          <div className="absolute h-[250px] w-[250px] sm:h-[300px] sm:w-[300px] lg:h-[340px] lg:w-[340px] rounded-full border border-slate-200/80 pointer-events-none" />
          <div className="absolute h-[140px] w-[140px] sm:h-[160px] sm:w-[160px] lg:h-[180px] lg:w-[180px] rounded-full border border-slate-200/60 pointer-events-none" />

          <div className="absolute h-[250px] w-[250px] sm:h-[300px] lg:h-[340px] flex items-center justify-center">
            <div className="block sm:hidden w-full h-full relative">
              <motion.div
                className="w-full h-full absolute"
                animate={{ rotate: 360 }}
          ...
          <div className="absolute h-[140px] w-[140px] sm:h-[160px] lg:h-[180px] flex items-center justify-center">
            <div className="block sm:hidden w-full h-full relative">
              <motion.div
                className="w-full h-full absolute"
                animate={{ rotate: -360 }}
