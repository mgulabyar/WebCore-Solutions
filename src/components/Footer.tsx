...
export default function Footer() {
  ...
  return (
    <footer ref={sectionRef} className="relative w-full overflow-hidden">
      ...
      <div className="relative bg-linear-to-b from-neutral-950 via-neutral-900 to-neutral-950 text-white pt-12 sm:pt-16 pb-10 sm:pb-12">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div
            className={`wc-signature-line grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 pb-10 lg:pb-12 border-b border-neutral-800 ${
              isVisible ? "wc-reveal-active" : ""
            }`}
          >
            <div
              style={{ transitionDelay: "0ms" }}
              className={`wc-float-left ${isVisible ? "wc-reveal-active" : ""} space-y-3`}
            >
              ...
              <p className="text-sm text-neutral-400 max-w-lg leading-relaxed">
                We engineer high-performance web applications, scalable
                platforms, and polished interfaces that help businesses move
            ...
            <div
              ...
              className={`wc-float-right ${isVisible ? "wc-reveal-active" : ""} lg:pl-10`}
            >
              ...
              <p className="text-sm text-neutral-400 max-w-md leading-relaxed">
                Subscribe to our newsletter for the latest insights, tech
                trends, and exclusive updates. Get actionable advice and
                step-by-step blueprints to build and scale your digital systems.
              ...
              >
                <div className="relative flex-1 group">
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-full border border-neutral-700 bg-neutral-800/50 pl-12 pr-5 py-3 text-sm text-white placeholder:text-neutral-500 focus:border-[#0076FF] focus:outline-none focus:ring-2 focus:ring-[#0076FF]/20 transition-all duration-300"
                  />
                </div>
                <button
                  type="submit"
                  className="wc-subscribe-btn group inline-flex items-center justify-center gap-2.5 rounded-full bg-linear-to-r from-[#0076FF] to-[#0B3C95] px-6 py-3 text-sm font-semibold text-white transition-all duration-300 hover:from-[#0B3C95] hover:to-[#0076FF] hover:shadow-none active:scale-95"
                >
                  Subscribe
...
//     <footer ref={sectionRef} className="relative w-full overflow-hidden">
//       <style>{`
//         /* Subtle float animations - not over the top */
//         .wc-float-left {
//           opacity: 0;
