...
//               © {new Date().getFullYear()} WebCore Solutions. All rights
//               reserved.
//             </p>
...
//       <div className="relative bg-gradient-to-b from-neutral-950 via-neutral-900 to-neutral-950 text-white pt-20 pb-16">
...
//         {/* Very subtle glow orbs - Low opacity */}
...
//                 <div className="flex h-13 w-13 items-center justify-center rounded-full bg-gradient-to-br from-[#0062D6] to-[#0B3C95] shadow-lg ring-1 ring-[#0062D6]/20">
...
//                 <button
//                   type="submit"
//                   className="inline-flex items-center justify-center gap-2.5 rounded-full bg-gradient-to-r from-[#0076FF] to-[#0B3C95] px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-[#0076FF]/25 transition-all duration-300 hover:from-[#0B3C95] hover:to-[#0076FF] hover:shadow-xl hover:shadow-[#0076FF]/35 active:scale-95"
//                 >
//                   Subscribe
...
//               {/* Trust badges - WITH REAL CONTENT */}
//               <div
//                 ref={sectionRef}
