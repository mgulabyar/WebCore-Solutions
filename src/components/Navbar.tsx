...
// //   return (
// //     <header className="sticky top-0 z-50 border-b border-neutral-100 shadow-sm bg-white backdrop-blur-xl">
// //       <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-3 py-4 sm:px-4 lg:px-6">
// //         <Link
// //           href="/"
...
//         <Link
//           href="/"
//           className="text-lg flex font-bold tracking-tight text-neutral-900 sm:text-xl transition-all duration-300 ease-out hover:-translate-y-0.5 hover:opacity-90 active:translate-y-0"
//         >
//           <img
//             src="/web.png"
//             alt="WebCore Solutions"
...
//                   isActive
//                     ? "text-[#0062D6]"
//                     : "text-neutral-600 hover:text-[#0062D6]"
//                 }`}
//               >
//                 {link.name}
//                 <span
//                   className={`absolute bottom-0 left-1/2 h-0.5 -translate-x-1/2 bg-[#0062D6] transition-all duration-350 ease-out origin-center ${
//                     isActive ? "w-full" : "w-0 group-hover:w-full"
//                   }`}
//                 />
//               </Link>
...
//           <Link
//             href="/contact"
//             className="rounded-full bg-[#0062D6] px-5 py-2 text-sm font-semibold text-white transition-all duration-300 ease-out hover:bg-[#0B3C95] hover:shadow-lg hover:shadow-blue-500/10 active:scale-95"
//           >
//             Get a Quote
//           </Link>
//         </div>
...
//               href="/contact"
//               onClick={() => setMenuOpen(false)}
//               className="mt-2 rounded-full bg-[#0062D6] px-5 py-2.5 text-center text-sm font-semibold text-white transition-all duration-300 hover:bg-[#0B3C95]"
//             >
//               Get a Quote
//             </Link>
//           </div>
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-neutral-100 shadow-sm bg-white backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-3 py-4 sm:px-4 lg:px-6">
        <Link
          href="/"
          className="flex items-center gap-2.5 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:opacity-90 active:translate-y-0"
        >
          <img
            src="/web.png"
            alt="WebCore Solutions"
